...
import { ColorSchema, Icon, Overlay, Questionire, SelectInput } from '../../components';
      ...
      {!group ? (
        <div className={styles.main}>
          ...
          <div>
            ...
            <br />
            Вместо этого мы будем рады бутылочке алкогольного напитка на {group?.appeal?.[4] || 'ваш'} вкус, которая
            позже будет задействована в интерактиве 😉
            <br />
            <br />
        ...
        <Icon iconName="rings" style={styles.rotating} />
      )}
    </div>
  );
};
